...
function GlassCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`w-full text-left rounded-2xl p-4 border backdrop-blur-2xl transition-all duration-200 ${
        selected
          ? 'bg-white/20 border-white/40 ring-2 ring-cyan-300/40 shadow-lg shadow-cyan-500/10'
          : 'bg-white/10 border-white/20 hover:bg-white/15 hover:border-white/30 hover:-translate-y-[1px]'
      }`}
    >
