...
import { authApi, ensureAccessTokenReady, otpApi } from '../services/api';
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ user, token, loading, isHydrated: !loading, requestOtp, verifyOtp, setSession, logout }}>
      {children}
