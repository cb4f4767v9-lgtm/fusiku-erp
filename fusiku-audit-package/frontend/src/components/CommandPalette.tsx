...
import { sidebarItemVisibleForVertical, type BusinessVertical } from '../utils/businessVertical';
  ...
  const actions: CommandPaletteAction[] = useMemo(() => {
    ...
    return [
      { id: 'nav.dashboard', kind: 'page', href: '/', permissionKey: 'dashboard.view', label: t('nav.dashboard') },
      {
        ...
        label: t('nav.pos'),
        keywords: ['sales', 'sell', 'checkout', 'invoice'],
      ...
      },
      {
        ...
        keywords: ['buy', 'supplier invoice'],
        hideForVerticals: ['institute'],
      },
      {
        id: 'action.newPurchase',
        kind: 'action',
        run: go('/purchases/new'),
        permissionKey: 'purchases.create',
        label: t('purchases.newPurchase'),
        keywords: ['create purchase', 'new purchase'],
        hideForVerticals: ['institute'],
      },
      {
        id: 'nav.suppliers',
      ...
      {
        id: 'nav.instituteStudents',
        kind: 'page',
        href: '/institute/students',
        permissionKey: 'institute.access',
        label: t('nav.instituteStudents'),
        keywords: ['institute', 'students', 'school'],
      ...
      },
      {
        ...
        label: t('nav.partsCatalog'),
        keywords: ['parts', 'catalog', 'bom'],
        onlyForVerticals: ['parts'],
      },
      {
        id: 'nav.sourcingRequests',
        kind: 'page',
        href: '/sourcing',
        permissionKey: 'sourcing.requests.manage',
        label: t('nav.sourcingRequests'),
        keywords: ['sourcing', 'procurement', 'rfq'],
    ...
    const items = actions
      ...
      .filter((a) =>
        sidebarItemVisibleForVertical(user, {
          onlyForVerticals: a.onlyForVerticals,
          hideForVerticals: a.hideForVerticals,
        })
      )
      .map((a) => {
